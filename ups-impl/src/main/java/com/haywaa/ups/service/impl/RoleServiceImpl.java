...
public class RoleServiceImpl implements RoleService {
    ...
    public void addRoleResourceIds(Integer roleId, List<Integer> resourceIds, OperatorInfo operator) {
        ...
        List<ResourceDO> systemResourceList = resourceDAO.selectBySystemCode(roleIndb.getSystemCode(), ValidStatus.VALID.getCode());
    ...
    public List<RoleDO> selectValidRolesByUserId(Long userId) {
        ...
        return roleDAO.selectByUserId(userId, ValidStatus.VALID.getCode());
    }
