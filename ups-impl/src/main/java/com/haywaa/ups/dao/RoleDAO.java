...
public interface RoleDAO {
    ...
    List<RoleDO> selectByUserId(@Param("userId") Long userId, @Param("status") Integer status);

    List<RoleDO> selectBySystemCode(@Param("systemCode") String systemCode, @Param("status") Integer status);
